  ...
  return (
    <div className='px-16 py-8 overflow-hidden h-screen'>
      ...
      <div className='grid grid-cols-3 grid-rows-3 gap-4 w-full h-5/6'>
        <div className='col-span-2 row-span-1 bg-gray-200 rounded-2xl'></div>
        <div className='col-span-1 row-span-2 bg-gray-200 rounded-2xl'></div>
        <div className='col-span-1 row-span-1 bg-gray-200 rounded-2xl'></div>
        <div className='col-span-1 row-span-1 bg-gray-200 rounded-2xl'></div>
        <div className='col-span-2 row-span-1 bg-gray-200 rounded-2xl'></div>
        <div className='col-span-1 row-span-1 bg-gray-200 rounded-2xl'></div> 
      </div>
